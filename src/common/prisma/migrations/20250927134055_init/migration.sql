...
-- CreateTable
CREATE TABLE "public"."team_season_performances" (
    "id" SERIAL NOT NULL,
    "wins" INTEGER,
    "losses" INTEGER,
    ...
    CONSTRAINT "team_season_performances_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "team_season_performances_team_id_season_id_key" ON "public"."team_season_performances"("team_id", "season_id");
...
-- AddForeignKey
ALTER TABLE "public"."team_season_performances" ADD CONSTRAINT "team_season_performances_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."team_season_performances" ADD CONSTRAINT "team_season_performances_season_id_fkey" FOREIGN KEY ("season_id") REFERENCES "public"."seasons"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
